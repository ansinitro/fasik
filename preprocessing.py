...
def load_data(filepath: str = "./data/faceit_players_dataset.csv") -> pd.DataFrame:
...
def save_processed_data(data_splits, feature_names):
    ...
    np.save("data/X_train.npy", data_splits["X_train"])
    np.save("data/X_val.npy", data_splits["X_val"])
    np.save("data/X_test.npy", data_splits["X_test"])
    np.save("data/y_train.npy", data_splits["y_train"])
    np.save("data/y_val.npy", data_splits["y_val"])
    np.save("data/y_test.npy", data_splits["y_test"])
